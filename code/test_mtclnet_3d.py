...
from utils.test_mtclnet_patch import test_all_case
...
snapshot_path = FLAGS.root_path + "model/{}_{}_{}_labeled/{}".format(FLAGS.dataset_name, FLAGS.exp, FLAGS.labelnum,
                                                                     FLAGS.model)
test_save_path = FLAGS.root_path + "model/{}_{}_{}_labeled/{}_predictions_2/".format(FLAGS.dataset_name, FLAGS.exp,
...
def test_calculate_metric():
    net = net_factory(net_type='mtclnet3d_v1', in_chns=1, class_num=num_classes, mode="test")
